...
Azure OpenAI Embedding Model integration for Chronos
...
Source code in this repository is made available under the [Apache License Version 2.0](https://github.com/intelligexhq/chronos/blob/main/LICENSE.md).
